...
/**
 * Face controller.
 * @RoutePrefix("/lostfound", name="lostfound")
 */
class IndexController extends Controller
{
     ...
     * Index action.
     * @return void
     * @Route("/", methods="GET", name="lostfound")
     */
    public function indexAction() {
        ...
        try{
            $data['data'] = [];
            $tickets = $this->app->lostfound->api->Helper()->getList($page);
            if(!empty($tickets)){
                $data['data'] = $tickets;
            }
        }catch (\Exception $e){
     ...
     * 商品详情
     * @return void
     * @Route("/detail", methods="GET", name="lostfound")
     */
    public function detailAction(){
        ...
        try{
            $result = $this->app->lostfound->api->Helper()->detail($goodsId,$this->_userId);
            if(empty($result)){
